...
class ViewPageData extends StatefulWidget {
  ViewPageData({Key? key, required this.document, required this.id})
      : super(key: key);
  final Map<String, dynamic> document;
  String id;

  @override
  State<ViewPageData> createState() => _ViewPageDataState();
}
...
class _ViewPageDataState extends State<ViewPageData> {
  ...
  void initState() {
    ...
    _taskController = TextEditingController(text: widget.document["title"]);
